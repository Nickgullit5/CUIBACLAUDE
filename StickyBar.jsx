  ...
  const sendMessage = async () => {
    ...
    try {
      const res = await fetch('https://formsubmit.co/ajax/nickcp2001@gmail.com', {
        ...
        body: JSON.stringify({
          _subject: 'Nuevo mensaje web — Cuiba Design',
          _template: 'table',
          Email: email,
          Mensaje: msg,
        }),
          ...
          <div style={{
            ...
            {sent ? (
              ...
              <>
                ...
                {error && <p style={{fontFamily:'Montserrat,sans-serif', fontSize:12, color:'#e07a5f', margin:'14px 0 0', lineHeight:1.5}}>No se pudo enviar. Llámanos al 611 637 679 o usa WhatsApp.</p>}
              </>
            )}
          </div>
        </div>
