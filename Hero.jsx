...
const HeroComponent = ({ onCTA, overlay = 0.72, accent = '#111110' }) => {
  ...
  return (
    <section style={{ position: 'relative', height: '100vh', minHeight: 600, overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        background: `linear-gradient(to right, rgba(10,10,9,${overlay}) 0%, rgba(10,10,9,${overlay*0.45}) 60%, rgba(10,10,9,${overlay*0.18}) 100%)`
      }} />
