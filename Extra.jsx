  ...
  return (
    <section id="proceso" style={{ background:'#F9F8F5', padding:'120px 8vw' }}>
      <div style={{ maxWidth:1200, margin:'0 auto' }}>
        <div className="process-grid" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'80px 120px', alignItems:'start' }}>
          {/* Left: heading */}
          ...
          <div style={{ display:'flex', flexDirection:'column' }}>
            ...
            <div style={{ borderTop:'1px solid #E5E4E0', paddingTop:40 }}>
              <button onClick={onCTA} style={{
                fontFamily:'Montserrat,sans-serif', fontSize:13, fontWeight:700,
                letterSpacing:'0.1em', textTransform:'uppercase',
                background:'#111110', color:'#F9F8F5', border:'none',
                ...
                Empieza tu proyecto
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M6 3l5 5-5 5" stroke="#F9F8F5" strokeWidth="1.5" strokeLinecap="round"/></svg>
              </button>
              <p style={{ fontFamily:'Montserrat,sans-serif', fontSize:13, fontWeight:300, color:'#999', margin:'16px 0 0' }}>
                Render 3D y presupuesto en 48h. Sin compromiso.
              </p>
            </div>
          </div>
        </div>
...
const ExtraComponent = ({ showTestimonials = true }) => {
  const testimonials = [
  ...
  return (
    <>
      ...
      <section style={{ background:'#111110', padding:'120px 8vw', overflow:'hidden' }}>
        <div className="viz-grid" style={{ maxWidth:1200, margin:'0 auto', display:'grid', gridTemplateColumns:'1fr 1fr', gap:'80px 80px', alignItems:'center' }}>
          <div>
      ...
      <section style={{ background:'#F9F8F5', padding:'120px 8vw' }}>
        <div style={{ maxWidth:1200, margin:'0 auto' }}>
          ...
          <div className="swipe-hint" style={{ display:'none', alignItems:'center', gap:10, marginBottom:24, fontFamily:'Montserrat,sans-serif', fontSize:12, fontWeight:600, letterSpacing:'0.1em', textTransform:'uppercase', color:'#999' }}>
            <span style={{ width:24, height:1, background:'#ccc' }}></span>
      ...
      <footer id="contacto" style={{ background:'#111110', padding:'80px 8vw 48px' }}>
        <div style={{ maxWidth:1200, margin:'0 auto' }}>
          <div className="footer-grid" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:80, paddingBottom:64, borderBottom:'1px solid rgba(249,248,245,0.1)' }}>
            <div>
              <img src="uploads/logo-cuiba-light.png" alt="Cuiba Design" style={{ height:40, marginBottom:32 }} />
              <p style={{ fontFamily:'Montserrat,sans-serif', fontSize:15, fontWeight:300, color:'rgba(249,248,245,0.5)', lineHeight:1.8, maxWidth:360, margin:'0 0 32px' }}>
                Boutique de diseño y reforma de cocinas y baños en Girona y la Costa Brava. Calidad sin compromisos.
              </p>
              <a href="https://wa.me/34611637679?text=Hola,%20me%20gustaría%20solicitar%20un%20presupuesto." target="_blank" rel="noopener noreferrer" style={{
                display:'inline-flex', alignItems:'center', gap:12,
                fontFamily:'Montserrat,sans-serif', fontSize:12, fontWeight:700,
                letterSpacing:'0.1em', textTransform:'uppercase',
                background:'#F9F8F5', color:'#111110', textDecoration:'none',
                padding:'16px 28px', transition:'all 0.3s'
              }}
                onMouseEnter={e => { e.currentTarget.style.transform='translateY(-2px)'; }}
                onMouseLeave={e => { e.currentTarget.style.transform='translateY(0)'; }}>
                Pedir presupuesto gratis
                <svg width="15" height="15" viewBox="0 0 16 16" fill="none"><path d="M6 3l5 5-5 5" stroke="#111110" strokeWidth="1.5" strokeLinecap="round"/></svg>
              </a>
            </div>
            <div className="footer-cols" style={{ display:'flex', gap:80 }}>
              <div>
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:12, alignItems:'flex-start' }}>
                  <a href="tel:+34611637679" style={{ fontFamily:'Montserrat,sans-serif', fontSize:15, fontWeight:400, color:'rgba(249,248,245,0.7)', textDecoration:'none', borderBottom:'1px solid transparent', transition:'all 0.25s' }}
                    onMouseEnter={e => { e.currentTarget.style.color='#F9F8F5'; e.currentTarget.style.borderBottomColor='rgba(249,248,245,0.5)'; }}
                    onMouseLeave={e => { e.currentTarget.style.color='rgba(249,248,245,0.7)'; e.currentTarget.style.borderBottomColor='transparent'; }}>611 637 679</a>
          ...
          <div style={{ paddingTop:32, display:'flex', justifyContent:'space-between', flexWrap:'wrap', gap:24, alignItems:'center' }}>
            ...
            <div style={{ display:'flex', gap:24, flexWrap:'wrap' }}>
              {[['Aviso Legal','aviso-legal.html'],['Política de Privacidad','privacidad.html'],['Política de Cookies','cookies.html']].map(([label, href]) => (
                <a key={href} href={href} style={{
                  fontFamily:'Montserrat,sans-serif', fontSize:12, color:'rgba(249,248,245,0.45)',
                  textDecoration:'none', transition:'color 0.25s'
                }}
                  onMouseEnter={e => e.currentTarget.style.color = '#F9F8F5'}
                  onMouseLeave={e => e.currentTarget.style.color = 'rgba(249,248,245,0.45)'}>{label}</a>
              ))}
              <button onClick={() => window.dispatchEvent(new Event('cuiba:open-cookie-settings'))} style={{
                fontFamily:'Montserrat,sans-serif', fontSize:12, color:'rgba(249,248,245,0.45)',
                background:'none', border:'none', padding:0, cursor:'pointer', transition:'color 0.25s'
              }}
                onMouseEnter={e => e.currentTarget.style.color = '#F9F8F5'}
                onMouseLeave={e => e.currentTarget.style.color = 'rgba(249,248,245,0.45)'}>Configurar cookies</button>
            </div>
          </div>
        </div>
      </footer>
